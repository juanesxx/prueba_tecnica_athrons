 ...
 * @author Gaurav
 */
public class Punto3Controller extends HttpServlet 
{
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        PaqueteDAO paqueteDAO=new PaqueteDAO();
        PaquetesDTO paquete1=paqueteDAO.obtenerPorID(1);
        ProductoDAO productoDAO= new ProductoDAO();
        ProductosDTO producto=productoDAO.obtenerPorID(3);
        
        request.setAttribute("paquete1",paquete1);
        request.setAttribute("producto",producto);
        request.getRequestDispatcher("punto3.jsp").forward(request, response); 
    }
